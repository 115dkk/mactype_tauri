...
- Helper bitmaps sit at device pixels or integer nearest-neighbour zoom inside it. Never scale, fade or CSS-invert a rendered sample, and never replace its palette with a skin surface.
