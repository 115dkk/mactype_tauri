...
- Rows live inside `settings-form`, whose container query stacks collection editors when the column is narrow. Fluent turns each row into a settings card and Cupertino into a group row.
