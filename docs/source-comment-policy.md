...
sources at the repository root are third-party for this purpose: their original
Japanese and Chinese commentary is the only documentation that code has, and it
stays. Test fixtures preserve their source bytes. New first-party comments are
English and use the established domain terms from `CONTEXT.md`.
